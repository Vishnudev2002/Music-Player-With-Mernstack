  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 border border-gray-300 gap-4 rounded-md">
      <input
        ...
        className="w-full p-3 rounded-md text-base font-semibold text-textColor border outline-none shadow-sm border-gray-300 bg-transparent"
        value={songName}
      ...
      <div className="flex items-center justify-center w-50 p-4">
        {isImageLoading || isAudioLoading ? (
          ...
          <motion.button
            whileTap={{ scale: 0.75 }}
            className="px-8 py-2 w-50 cursor-pointer rounded-md text-white bg-red-600 hover:shadow-lg"
            onClick={saveSong}
          >
            Save song
          </motion.button>
