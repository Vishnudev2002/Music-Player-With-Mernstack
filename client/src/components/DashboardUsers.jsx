...
export const DashboardUserCard = ({ data, index }) => {
  ...
  return (
    <motion.div
      key={index}
      className="relative w-full rounded-md flex items-center justify-between py-4 bg-lightOverlay cursor-ointer hover:bg-card hover:shadow-md"
    >
      ...
      <div className="w-275 min-w-[160px] text-center flex items-center justify-center gap-6 relative">
        ...
        {data._id !== user?.user._id && (
          <motion.p
            ...
            className="cursor-pointer text-[10px] font-semibold text-textColor px-1 bg-purple-200 rounded-sm hover:shadow-md"
          >
