    ...
    <div className="w-full flex items-center gap-3">
      <div className={`w-full items-center flex gap-3 p-4 relative`}>
        <img
          ...
          alt=""
          className="w-40 h-20 object-fit rounded-md"
        />
...
export const PlayListCard= () =>{
  ...
  return(
    <div className="absolute left-4 bottom-24 gap-3 py-2 w-350 max-w-[350px] h-510 max-h-[510px] flex flex-col overflow-y-scroll scrollbar-thin rounded-md shadow-md bg-primary"> 
    {allSongs.length > 0 ? (
      allSongs.map((music, index) => (
        <motion.div
          ...
          className={`group w-full p-4 hover:bg-card flex gap-3 items-center cursor-pointer bg-transparent"${
            music?._id === index? "bg-card" : "bg-transparent"
          }`}
